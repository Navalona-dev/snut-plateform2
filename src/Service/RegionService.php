...
class RegionService
{
    ...
    public function getAllRegion($em, $start = 0, $limit = 0, $search = "")
    {
        return $em->getRepository(Region::class)->getAllRegion($start, $limit, $search);
    }

    public function getNombreTotalRegion($em)
    {
        return $em->getRepository(Region::class)->countAll();
    }
}
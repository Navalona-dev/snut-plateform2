...
class ProvinceService
{
    ...
    public function getAllProvince($em, $start = 0, $limit = 0, $search = "")
    {
        return $em->getRepository(Province::class)->getAllProvince($start, $limit, $search);
    }

    public function getNombreTotalProvince($em)
    {
        return $em->getRepository(Province::class)->countAll();
    }
}
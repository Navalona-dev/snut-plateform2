...
use App\Entity\AnneeHospitalierUniversitaire;
use App\Entity\AnneeRecuperation;
...
class MoisProjectionService
{
    ...
    public function getAllMoisProjectionTrimestrielle($em, $start = 0, $limit = 0, $search = "")
    {
        return $em->getRepository(MoisProjectionsAdmissions::class)->getAllMoisProjectionTrimestrielle($start, $limit, $search);
    }

    public function getNombreTotalMoisProjectionTrimestrielle($em)
    {
        return $em->getRepository(MoisProjectionsAdmissions::class)->countAll();
    }

    public function getAllMoisProjectionSemestrielle($em, $start = 0, $limit = 0, $search = "")
    {
        return $em->getRepository(CreniMoisProjectionsAdmissions::class)->getAllMoisProjectionSemestrielle($start, $limit, $search);
    }

    public function getNombreTotalMoisProjectionSemestrielle($em)
    {
        return $em->getRepository(CreniMoisProjectionsAdmissions::class)->countAll();
    }
}
...
class CommandeService
{
    ...
    public function getAllCommandeTrimestrielle($em, $start = 0, $limit = 0, $search = "")
    {
        return $em->getRepository(CommandeTrimestrielle::class)->getAllCommandeTrimestrielle($start, $limit, $search);
    }

    public function getNombreTotalCommandeTrimestrielle($em)
    {
        return $em->getRepository(CommandeTrimestrielle::class)->countAll();
    }

    public function getAllCommandeSemestrielle($em, $start = 0, $limit = 0, $search = "")
    {
        return $em->getRepository(CommandeSemestrielle::class)->getAllCommandeSemestrielle($start, $limit, $search);
    }

    public function getNombreTotalCommandeSemestrielle($em)
    {
        return $em->getRepository(CommandeSemestrielle::class)->countAll();
    }
}
...
class AnneeService
{
    ...
    public function getAllAnnee($em, $start = 0, $limit = 0, $search = "")
    {
        return $em->getRepository(AnneePrevisionnelle::class)->getAllAnnee($start, $limit, $search);
    }

    public function getNombreTotalAnnee($em)
    {
        return $em->getRepository(AnneePrevisionnelle::class)->countAll();
    }
}
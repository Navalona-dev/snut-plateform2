...
class MoisPrevionnelleService
{
    ...
    public function getAllMois($em, $start = 0, $limit = 0, $search = "")
    {
        return $em->getRepository(MoisPrevisionnelleEnclave::class)->getAllMois($start, $limit, $search);
    }

    public function getNombreTotalMois($em)
    {
        return $em->getRepository(MoisPrevisionnelleEnclave::class)->countAll();
    }
}
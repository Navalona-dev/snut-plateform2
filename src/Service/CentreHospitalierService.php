...
class CentreHospitalierService
{
    ...
    public function getAllCentre($em, $start = 0, $limit = 0, $search = "")
    {
        return $em->getRepository(CentreHospitalierUniversitaire::class)->getAllCentre($start, $limit, $search);
    }

    public function getNombreTotalCentre($em)
    {
        return $em->getRepository(CentreHospitalierUniversitaire::class)->countAll();
    }
}
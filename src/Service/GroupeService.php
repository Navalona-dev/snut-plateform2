...
class GroupeService
{
    ...
    public function getAllGroupe($em, $start = 0, $limit = 0, $search = "")
    {
        return $em->getRepository(Groupe::class)->getAllGroupe($start, $limit, $search);
    }

    public function getNombreTotalGroupe($em)
    {
        return $em->getRepository(Groupe::class)->countAll();
    }
}
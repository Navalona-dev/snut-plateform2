...
(function() {
  ...
  if (!raw) {
    document.write('<scr' + 'ipt type="text/javascript" src="dist/js/ol_3.js"></scr' + 'ipt>');
  } else {
    window.CLOSURE_NO_DEPS = true; // we've got our own deps file
    document.write('<scr' + 'ipt type="text/javascript" src="dist/js/base_4.js"></scr' + 'ipt>');
    document.write('<scr' + 'ipt type="text/javascript" src="dist/js/ol-deps-4.js"></scr' + 'ipt>');
